    ...
    <div className="min-h-screen bg-[#030303] text-zinc-100 pb-24 pt-28 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-semibold text-violet-400 uppercase tracking-widest bg-violet-500/10 border border-violet-500/20 px-3 py-1 rounded-full flex items-center gap-1.5">
              ...
              <div>
                ...
                <div className="space-y-4 text-xs sm:text-sm">
                  <div>
                    ...
                    <span className="text-zinc-300 font-medium mt-1 block">{project.category.name}</span>
                  </div>
                  <div>
                  ...
                  {projectLinks.map((link, index) => {
                    ...
                    return (
                      <a
                        ...
                        className={
                          isPrimary
                            ? "w-full py-3 bg-white hover:bg-zinc-200 text-zinc-950 rounded-xl font-semibold text-xs uppercase tracking-wider transition-colors flex items-center justify-center gap-2 md:cursor-none shadow-md"
    ...
    if (part.startsWith("**") && part.endsWith("**")) {
      ...
      return (
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer" 
          className="text-violet-400 hover:text-violet-300 underline font-medium inline-flex items-center gap-0.5 md:cursor-none"
        >
